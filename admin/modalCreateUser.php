...
<form method="post" action="insertUser.php" enctype="multipart/form-data" >
  ...
  <div class="row">
    <div class="col-sm-12 col-12"> 
      <div class="form_group">
        ...
        <input class="form-control" type="email" name="email_address" id="email_address" value="" oninput="member_checker()" maxlength="250"  required />
      </div>
    </div> 
  </div> 
  ...
  <div class="col-sm-12 col-12"> 
    <div class="form_group">
      ...
      <input type="tel" class="form-control"  required id="contact_number" name="contact_number"  value=""  maxlength="11" minlength="11" required />
    </div>
  </div> 
</div> 
