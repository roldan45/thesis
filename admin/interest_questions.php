      ...
      <div class="col-lg-12 col-12">
          <div class="small-box badge-info">
              <div class="inner"><center>
                  <h3>Interest</h3>Question '.$_SESSION['question_count'].'</center>
              </div>
          </div>
      </div>
          <div class="card">
            <div class="card-body">
              <div id="questions">
                <center>
                 ...
                 <input type="hidden" value="interest" name="category"/> 
                <button type="submit" name="btn_submit1" class="btn btn-success" >NEXT <i class="fas fa-arrow-right"></i></button>
             </center>
          </div>
        </div>
      </div>
